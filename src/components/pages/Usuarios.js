  ...
  return (
    <div className='container mx-auto max-w-7xl'>
      <div className="text-white">
        <h1 className="text-4xl font-bold leading-none tracking-tight text-white text-center dark:text-white my-10">Usuarios {  text && text } </h1>
        <div>
          <Link to={'/usuarios/add'} className="btn btn-accent hover:btn-accent capitalize text-md"> nuevo usuario</Link>
        </div>
        <div className="hidden md:grid md:grid-cols-10 md:grid-rows-1 bg-slate-900 rounded-md mb-0 my-2 border-1 border-white md:pl-2">
        ...
        <div className="my-2 md:my-0">
          { usuarios.map( usuario => (
            <div key={uuidv4()} className="text-md my-1 md:my-1 bg-slate-900 rounded-md">
              <div className='grid grid-cols-1 grid-rows-5 py-2 px-4 md:grid-rows-1 md:grid-cols-10 text-white'>
                <div className="md:flex md:items-center md:col-start-1 md:col-end-2">
                  <div className='block w-full md:col-start-1 md:col-end-2 py-2'> 
                    <p className="block md:hidden text-1xl bg-slate-800 font-bold capitalize">ID:</p>
                ...
                <div className="md:flex md:items-center md:col-start-2 md:col-end-4">
                  <Link to={`/usuarios/${usuario.id_usuario}`} className='block w-full'>
                    <div>
                      <p className="block md:hidden text-1xl bg-slate-800 font-bold capitalize">nombre:</p>
                ...
                <div className="md:flex md:items-center md:col-start-4 md:col-end-7">
                  <div className='block w-full'> 
                    <p className="block md:hidden text-1xl bg-slate-800 font-bold capitalize">email:</p>
                ...
                <div className="md:flex md:items-center md:col-start-7 md:col-end-8 2xl:col-start-7 2xl:col-end-8">
                  <p className="block md:hidden text-1xl bg-slate-800 font-bold capitalize">role:</p>
                ...
                <div className="md:flex md:items-center md:justify-center md:col-start-9 md:col-end-11 2xl:col-start-9 2xl:col-end-11">
                  <div className="flex flex-row justify-center gap-2 items-center md:grid lg:flex lg:flex-row lg:gap-2"> 
                    <Link to={`/usuarios/${usuario.id_usuario}`} className='btn md:btn-sm  capitalize btn-accent flex items-center'>Detalle</Link>
