      ...
      <div className='text-white md:col-start-4 md:col-end-11'>
          <div className='grid grid-cols-2 md:grid-cols-5 lg:grid-cols-6 md:gap-3 gap-3 text-md'>
              { votosCandidatos.map( (candidato, index) => {
                ...
                return (
                  <div key={ uuidv4() } className='border-1  p-2 flex flex-col items-center justify-start gap-1 rounded-md bg-slate-100 text-slate-950 font-semi-bold shadow-sm'>
                    <div className='grid grid-rows-3 w-full'>
                      <div className='row-start-1 row-end-4 flex flex-col'>
                        ...
                        <p className='text-center text-2xl border-1 border-slate-600 py-1 rounded-md w-full'>{ candidato.votos && agregarPuntosDeMil(candidato.votos) }</p>
                      </div>
              ...
              <div className='border-1 p-2 flex flex-col items-center justify-start gap-1 rounded-md bg-slate-100 text-slate-950 font-semi-bold shadow-sm'>
                <div className='grid grid-rows-3 w-full'>
                  <div className='row-start-1 row-end-4 flex flex-col'>
                    <div className='flex flex-col items-center justify-center h-auto'>
                      <img src={ iconVotoBlanco } alt='imagen-candidato' className=' h-auto my-2 rounded-full' />
                    </div>
                    <p className='text-center text-2xl border-1 border-slate-600 py-1 rounded-md w-full'>{ votosPorOtrasOpciones.votos_blancos }</p>
                  </div>
                  <div className='row-start-4 row-end-5 '>
                    <p className='text-center'>votos </p>
                    <p className='text-center h-20'></p>
              ...
              <div className='border-1  p-2 flex flex-col items-center justify-start gap-1 rounded-md bg-slate-100 text-slate-950 font-semi-bold shadow-sm'>
                <div className='grid grid-rows-3 w-full'>
                  <div className='row-start-1 row-end-4 flex flex-col'>
                    ...
                    <p className='text-center text-2xl border-1 border-slate-600 py-1 rounded-md w-full'>{ votosPorOtrasOpciones.votos_nulos }</p>
                  </div>
                  <div className='row-start-4 row-end-5 '>
                    <p className='text-center'>votos </p>
                    <p className='text-center h-20'></p>
              ...
              <div className='border-1  p-2 flex flex-col items-center justify-start gap-1 rounded-md bg-slate-100 text-slate-950 font-semi-bold shadow-sm'>
                <div className='grid grid-rows-3 w-full'>
                  <div className='row-start-1 row-end-4 flex flex-col'>
                    ...
                    <p className='text-center text-2xl border-1 border-slate-600 py-1 rounded-md w-full'>{ votosPorOtrasOpciones.votos_no_marcados }</p>
                  </div>
                  <div className='row-start-4 row-end-5 '>
                    <p className='text-center'>votos </p>
                    <p className='text-center h-20'></p>
